...
app = FastAPI(title="TECK TRACK - AI Service", description="Microservice d'Intelligence Artificielle pour la maintenance prédictive")
...
def predict_stock_depletion(data: PredictionRequest):
    """
    ...
    for part in data.parts:
        ...
        df = pd.DataFrame([c.dict() for c in part.consumptions])
        ...
        # Pour une prédiction de rupture de stock, nous avons besoin du taux moyen
        # On s'assure qu'on a un taux positif
